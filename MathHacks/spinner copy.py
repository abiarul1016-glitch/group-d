...
def main():
    ...
    # Group creating algorithm
    # Weight the people who don't work well together more than
...
def find_best_groups()
    ...
    for _ in iterations:
        ...
        current_score = get_score(current_groups)
...
def get_score(groups):
    ...
    for group in groups:
        ...
        for p1, p2 in pairs_together:
            if p1 ^ p2 in group:
                score += 10

        # Not together pairs punishment
        for p1, p2 in pairs_not_together:
